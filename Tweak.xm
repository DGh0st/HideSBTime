...
-(void)setVisible:(BOOL)arg1 frame:(CGRect)arg2 duration:(CGFloat)arg3 {
	BOOL isInStatusBarWindow = self.superview != nil && self.superview.superview != nil && self.superview.superview.superview != nil && [self.superview.superview.superview isKindOfClass:%c(UIStatusBarWindow)];
	if (isInStatusBarWindow) {
		...
		if (isHomescreen || isLockscreen)
			arg1 = NO;*/
		arg1 = NO; // should hide all springboard status bars that are in windows
	}
	%orig(arg1, arg2, arg3);
}
%end